...
<script type="text/html" id="facet-toggle">
  <div class="facet-field-tile">
    ...
    ##  && ! properties.isMathDate()
    <!-- ko if: properties.isDate() && type() == 'range-up' -->
      Is math <input type="checkbox" data-bind="checked: properties.isMathDate" />
<br/>
      <div class="facet-field-cnt">
        <span class="spinedit-cnt">
          <input type="text" class="input-medium" data-bind="spinedit: properties.limit"/>
...
since today.      
      <br/>
      custom format <input type="checkbox" />
          ...
          <div class="trigger-exclude">
            <!-- ko if: ! selected -->
              <a class="pointer" data-bind="attr: {title: $data.from}, text: function() {
                 if ($parent.properties.math_gap() != 1) {
                   ...
                   if ($parent.properties.sort() == 'desc') {
                     ...
                     return ($index() + 1) + ' ' + $parent.properties.math_interval() + ' ago';
                   }
                 }
