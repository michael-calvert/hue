...
<link href="${ static('desktop/jobbrowser/css/jobbrowser.css') }" rel="stylesheet">
...
<script src="${ static('desktop/jobbrowser/js/utils.js') }" type="text/javascript" charset="utf-8"></script>
