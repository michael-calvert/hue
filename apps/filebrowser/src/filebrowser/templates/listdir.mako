        ...
        <div class="btn-toolbar" style="display: inline; vertical-align: middle">
          <div id="ch-dropdown" class="btn-group" style="vertical-align: middle">
            ...
            <ul class="dropdown-menu" style="top: auto">
              <li><a href="#" title="${_('Rename')}" data-bind="visible: !inTrash(), click: renameFile,
              ...
              <li class="divider"></li>
              <!-- ko ifnot: inTrash -->
              <li><a href="#"  data-bind="enable: selectedFiles().length > 0 && isCurrentDirSelected().length == 0,
              click: trashSelected"><i class="fa fa-times"></i> ${_('Move to trash')}</a></li>
              <!-- /ko -->
            </ul>
          </div>
