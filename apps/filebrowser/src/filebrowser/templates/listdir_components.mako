  ...
  (function () {
    ...
    var ShowHistory = function (num) {
      ...
      history.forEach(function (item) {
        ...
        anchor.href = url + item;
        anchor.appendChild(doc.createTextNode(item));
        list.appendChild(anchor);
        frag.appendChild(list);;
      });

      doc.querySelector('#hashHistory').appendChild(frag);
    ...
    $(document).ready(function () {
      ...
      if (window.FileReader) {
        ...
        $('.historyLink').on('click', function (e) {
          document.querySelector('#hashHistory').innerHTML = "";
          new ShowHistory();
        });
